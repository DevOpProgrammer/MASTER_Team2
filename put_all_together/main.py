...
prefix = 'original' # ['original','opensource'], which training data are you using
train_data_dir = f'./data'
with open(f'/home/l/下載/MASTER/data/csi300_dl_train.pkl', 'rb') as f:
    dl_train = pickle.load(f)

with open(f'/home/l/下載/MASTER/data/csi300_dl_valid.pkl', 'rb') as f:
...
for seed in [0, 1, 2, 3, 4]:
    ...
    start = time.time()
    # Train
    model.fit(dl_train, dl_valid, seed)
