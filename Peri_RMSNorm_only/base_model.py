...
class SequenceModel():
    ...
    def fit(self, dl_train, dl_valid=None, train_hist_filename='training_history'):
        ...
        torch.save(best_param, "best_param/csi300_opensource_0.pkl")

    def _save_training_history(self, train_loss, ic, icir, ric, ricir, filename=None, dir='./training_history'):
        """
        ...
        file_path = os.path.join(dir, f"{filename}.pkl")
