...
with open(f'opensource/csi300_dl_train.pkl', 'rb') as f:
    dl_train = pickle.load(f)

predict_data_dir = f'./data/opensource'
with open(f'opensource/csi300_dl_valid.pkl', 'rb') as f:# opensource\csi300_dl_valid.pkl
    dl_valid = pickle.load(f)
with open(f'opensource/csi300_dl_test.pkl', 'rb') as f:
...
for seed in [0, 1, 2, 3, 4]:
    model = MASTERModel(
        ...
        save_path='model', save_prefix=f'{universe}_{prefix}', drop_path=0.0
    )
